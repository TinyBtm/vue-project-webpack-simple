...
export default {
  ...
  methods: {
    ...
    fOnDragOver(e) {
      const dTarget = e.target;
      const { dDragging } = this;
      const nTargetTop = dTarget.getBoundingClientRect().top;
      const nDraggingTop = dDragging.getBoundingClientRect().top;
    ...
    fDoAnim(nStartPos, dEl) {
      const nOffset = nStartPos - dEl.getBoundingClientRect().top;
